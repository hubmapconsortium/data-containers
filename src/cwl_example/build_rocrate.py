...
def main():
    run("cwltool --provenance prov1 hello_world.cwl",
        shell=True, check=True)
    run("cwltool --provenance prov2 hello_world.cwl --message 'hola'",
        shell=True, check=True)
    crate = ROCrate()
    ...
    for bag in ["prov1", "prov2"]:
        ...
        try:
            ...
            print(f"Skipping {bag_path} because it could not be"
